    ...
    <div class="max-w-[1240px] mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            @foreach($pidanas as $index => $pidana)
                ...
                <div class="flex flex-col h-full bg-white border border-kej-border rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group animate-fade-in" style="animation-delay: {{ $index * 100 }}ms;">
